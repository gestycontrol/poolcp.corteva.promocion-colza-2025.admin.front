<template>
    <i :class="{ 'custom-icon': !inline, 'custom-icon__big': big, 'custom-icon__inline': inline }">
        <svg version="1.1" id="Livello_1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;" width="16"
            height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 2160 2160"
		...
		v27.2C1536.5,521.2,1511.8,541.9,1478.9,541.9z" />
                <path class="st1"
                    d="M1795.9,344.2h-33.1L1699.7,529h-1.1l-63.1-184.8H1601l82.5,224.4l-4.2,13.5c-6.5,22.8-17.7,36.1-43.7,36.1
